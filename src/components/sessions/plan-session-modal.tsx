...
import { X, Calendar, Target, AlertTriangle, Plus, Trash2, CalendarDays, Repeat, CheckCircle2, Database, ChevronDown, ChevronUp } from 'lucide-react';
...
export function PlanSessionModal({ group, isOpen, onClose, onSave }: PlanSessionModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className={`relative bg-white rounded-xl shadow-xl w-full ${isWilsonCurriculum || isCaminoCurriculum ? 'max-w-6xl h-[95vh]' : 'max-w-2xl max-h-[90vh]'} overflow-hidden flex flex-col`}>
        {/* Header */}
        ...
        {/* Content */}
        <div className={`flex-1 overflow-hidden ${isWilsonCurriculum || isCaminoCurriculum ? 'flex flex-col' : 'overflow-y-auto'}`}>
          {/* Compact Header with Date/Time for Wilson/Camino */}
          {(isWilsonCurriculum || isCaminoCurriculum) ? (
            <>
              ...
              <div className="flex-shrink-0 px-4 py-3 bg-gray-50 border-b space-y-3">
                    ...
                    <div className="flex items-center gap-3 pl-3 border-l">
                      ...
                      <label className="flex items-center gap-1 text-xs text-gray-600 cursor-pointer">
                        <input
                          ...
                          className="rounded border-gray-300 text-pink-500 focus:ring-pink-500 w-3 h-3"
                        />
                        Skip weekends
                      </label>
                    </div>
                ...
                {showAdvancedSettings && (
                  <div className="pt-3 border-t space-y-4">
                    ...
                    {/* Response Formats */}
                    <div>
                      <label className="text-sm font-medium text-gray-700 mb-1 block">Response Formats</label>
                      <div className="flex flex-wrap gap-1">
                    ...
                    {/* Notes */}
                    <div>
                      <label className="text-sm font-medium text-gray-700 mb-1 block">Planning Notes</label>
                      <textarea
                        value={notes}
            ...
            /* Original Layout for non-Wilson/Camino curricula */
        ...
        {/* Footer */}
        <div className="flex-shrink-0 bg-white border-t px-6 py-4 flex justify-end gap-3">
